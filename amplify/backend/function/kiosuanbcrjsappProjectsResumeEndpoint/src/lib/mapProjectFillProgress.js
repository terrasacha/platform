...
const getLimitationsInfoStatus = (data) => {
  ...
  if (!restrictionsDesc) tempStatus = "No";
  if (!restrictionsOther) tempStatus = "No";
...
const getEcosystemInfoStatus = (data) => {
  ...
  if (!projectEcosystem) tempStatus = "No";
...
const getGeneralInfoStatus = (data) => {
  ...
  if (!propertyGeneralAspects) tempStatus = "No";
...
const getRelationsInfoStatus = (data) => {
  ...
  if (!technicalAssistance) tempStatus = "No";
  if (!strategicAllies) tempStatus = "No";
  if (!communityGroups) tempStatus = "No";
