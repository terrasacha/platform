              ...
              <div className='row'>
                <div className='col' >
                  <div >
                    ...
                    <p>Nuestra plataforma se apalanca en tecnología blockchain para lograr total transparencia en los proyectos</p>
                  </div>
                </div>
                <div className='col'>
                  <div >
                  <svg className='m-auto d-block' xmlns="http://www.w3.org/2000/svg" height="124" viewBox="0 -960 960 960" width="124" fill="#6B8E0F"><path d="M480-80 120-280v-400l360-200 360 200v400L480-80ZM364-590q23-24 53-37t63-13q33 0 63 13t53 37l120-67-236-131-236 131 120 67Zm76 396v-131q-54-14-87-57t-33-98q0-11 1-20.5t4-19.5l-125-70v263l240 133Zm40-206q33 0 56.5-23.5T560-480q0-33-23.5-56.5T480-560q-33 0-56.5 23.5T400-480q0 33 23.5 56.5T480-400Zm40 206 240-133v-263l-125 70q3 10 4 19.5t1 20.5q0 55-33 98t-87 57v131Z"/></svg>
                    ...
                    <p>Tus inversiones se verán reflejadas en tokens que con el tiempo aumentarán su valor</p>
                  </div>
                </div>
                <div className='col'>
                  <div >
                ...
                <div className='col'>
                  ...
                  <svg className='m-auto d-block' xmlns="http://www.w3.org/2000/svg" height="124" viewBox="0 -960 960 960" width="124" fill="#6B8E0F"><path d="M480-100q-79 0-148-30t-120.5-81.5Q160-263 130-332t-30-148q0-79 30-148t81.5-120.5Q263-800 332-830t148-30v-100l160 160-160 160v-100q-108 0-184 76t-76 184q0 66 30.5 122.5T332-266q16-28 47.5-47.5T452-338q-3-21-8-42t-12-39q-11 9-24 14t-28 5q-33 0-56.5-23.5T300-480v-40q0-17-5.5-32T280-580q50-1 89 9 34 9 62 29.5t29 61.5q0 9-1.5 16.5T453-448q-13-10-26-18t-27-14q17 13 39 40t41 64q20-49 50-96.5t70-87.5q-23 16-44 34t-41 38q-7-11-11-24.5t-4-27.5q0-42 29-71t71-29h40q23 0 38-6t25-14q11-9 17-20 4 67-7 120-9 45-34 82.5T600-440q-15 0-28.5-4T547-455q-7 19-16 50.5T517-337q38 7 67 26t44 45q51-35 81.5-91T740-480h120q0 79-30 148t-81.5 120.5Q697-160 628-130t-148 30Z"/></svg>
                    ...
                    <p>Contamos con un equipo de expertos que se asegurarán de completar y calificar cada proyecto.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='container-fluid bg-tecnologia p-5'id="tecnologia">
            <div className='container'>
              ...
              <div className=''>
                <div className='row'>
                <div className='col'>
                    <img src={blockchain} alt="drones" className='iconstech' width='124'/>               
                  </div>                  <div className='col' >
                    <h4 className=''>BLOCKCHAIN</h4>
                    <p>Revolucionamos los mercados de carbono al hacer públicas e inmutables todas las transacciones, estableciendo un estándar inigualable de transparencia. Cada proceso de eliminación de carbono se origina, rastrea y completa en la cadena de bloques.</p>
                  </div>
                </div>
                <hr></hr>
                <div className='row'>
                  <div className='col' >
                    ...
                    <p>Utilizamos drones para la revisión de los terrenos y emitir los resultados de la reducción de CO2</p>
                  </div>
                  <div className='col'>
                    <img src={drones} alt="drones" className='iconstech' width='124'/>               
                  </div>
                </div>
                <hr></hr>
                <div className='row'>
                <div className='col'>
                    <img src={plataforma} alt="drones" className='iconstech' width='124'/>               
                  </div>                  <div className='col' >
                    <h4 className=''>PLATAFORMA SUAN</h4>
                    <p>Ten control total de tus proyectos y de tus inversiones desde nuestra plataforma,  conecta facilmente tu wallet con nosotros y obten tus tokens de manera inmediata.</p>
                  </div>
                </div>
              </div>
            </div>
