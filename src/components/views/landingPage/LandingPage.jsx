       ...
       <Modal show={this.state.showModal} onClose={this.handleClose}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 m-4 p-2">
            <div className="col-span-1 sm:col-span-2 md:col-span-1 lg:col-span-1">
              <div className={s.titleContainerProducts}>
                ...
                <p className="p-5">
                  Adquiere la capacidad de <strong>neutralizar carbono</strong>, respalda la agricultura regenerativa y genera un impacto en el que puedas confiar plenamente. Cada Tonelada está respaldada por <strong>tecnología Blockchain</strong>, y se entrega con un certificado que ofrece una transparencia total sobre el proyecto específico de eliminación de carbono.
                </p>
              </div>
            </div>
            <div className="col-span-1 sm:col-span-2 md:col-span-1 lg:col-span-1">
              ...
              <div className="p-4">
                ...
                <div classname="col">
                  ...
                  <svg classname="m-auto d-block iconstech" xmlns="http://www.w3.org/2000/svg" height="124" viewBox="0 -960 960 960" width="124" fill="#6B8E0F"><path d="M480-100q-79 0-148-30t-120.5-81.5Q160-263 130-332t-30-148q0-79 30-148t81.5-120.5Q263-800 332-830t148-30v-100l160 160-160 160v-100q-108 0-184 76t-76 184q0 66 30.5 122.5T332-266q16-28 47.5-47.5T452-338q-3-21-8-42t-12-39q-11 9-24 14t-28 5q-33 0-56.5-23.5T300-480v-40q0-17-5.5-32T280-580q50-1 89 9 34 9 62 29.5t29 61.5q0 9-1.5 16.5T453-448q-13-10-26-18t-27-14q17 13 39 40t41 64q20-49 50-96.5t70-87.5q-23 16-44 34t-41 38q-7-11-11-24.5t-4-27.5q0-42 29-71t71-29h40q23 0 38-6t25-14q11-9 17-20 4 67-7 120-9 45-34 82.5T600-440q-15 0-28.5-4T547-455q-7 19-16 50.5T517-337q38 7 67 26t44 45q51-35 81.5-91T740-480h120q0 79-30 148t-81.5 120.5Q697-160 628-130t-148 30Z"></path></svg>
                    ...
                    <p className='text-center'>Contamos con un equipo de expertos que se asegurarán de completar y calificar cada proyecto.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="gap-2">
              ...
              <div className="mb-8 flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2">
                  ...
                  <p className="text-center md:text-left pr-5">Revolucionamos los mercados de carbono al hacer públicas e inmutables todas las transacciones, estableciendo un estándar inigualable de transparencia. Cada proceso de eliminación de carbono se origina, rastrea y completa en la cadena de bloques.</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex flex-col md:flex-row items-center">
                ...
                <img src={drones} alt="drones" className="m-auto d-block iconstech mb-4 md:mb-0  md:w-1/2" width="124" />
              </div>
              <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700"/>
              ...
              <div className="mb-8 flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2">
                  ...
                  <p className="text-center md:text-left pr-5">Ten control total de tus proyectos y de tus inversiones desde nuestra plataforma, conecta fácilmente tu wallet con nosotros y obtén tus tokens de manera inmediata.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='container'>
            <h2 className='p-4'>¿Quieres conocer más?</h2>
              <div className='row'>
                <div className='col'>
                  <a className='m-auto d-block btn-landing text-center' href='https://suan-1.gitbook.io/documentacion-suan-sandbox/' target="_blank" rel='noreferrer'>
                  ¿Como entrar?
                  </a>
                </div>
                <div className='col'>
                  <a className='m-auto d-block btn-landing text-center' href='https://suan-1.gitbook.io/documentacion-suan/' target="_blank" rel='noreferrer'>
