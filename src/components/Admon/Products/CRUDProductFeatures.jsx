                ...
                <tbody>
                    ...
                    <td>
                        ...
                        {this.state.CRUDButtonName === 'UPDATE' ? (
                            <div classname="btninline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline">
