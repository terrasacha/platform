...
export default function ImageCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setImageURLToDisplay(initialValues.imageURLToDisplay);
    setIsOnCarousel(initialValues.isOnCarousel);
    setCarouselLabel(initialValues.carouselLabel);
    setCarouselDescription(initialValues.carouselDescription);
