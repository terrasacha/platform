...
export default function TokenCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSupply(initialValues.supply);
    setOraclePrice(initialValues.oraclePrice);
    setErrors({});
  };
  const validations = {
    policyID: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createToken.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TokenCreateForm")}
      {...rest}
    >
      <TextField
        label="Policy id"
