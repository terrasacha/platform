...
export default function ScriptCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setScript_type(initialValues.script_type);
    setScript_category(initialValues.script_category);
    setPbk(initialValues.pbk);
    setCurrentPbkValue("");
    setToken_name(initialValues.token_name);
    setCbor(initialValues.cbor);
    setTestnetAddr(initialValues.testnetAddr);
    setMainnetAddr(initialValues.MainnetAddr);
    setActive(initialValues.Active);
    setBase_code(initialValues.base_code);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createScript.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ScriptCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
