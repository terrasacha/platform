...
export default function PaymentUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = paymentRecord
      ...
      : initialValues;
    setOrderType(cleanValues.orderType);
    setRef(cleanValues.ref);
    setWalletAddress(cleanValues.walletAddress);
    setStatusCode(cleanValues.statusCode);
    setWalletStakeAddress(cleanValues.walletStakeAddress);
    setTokenName(cleanValues.tokenName);
    setTokenAmount(cleanValues.tokenAmount);
    setFee(cleanValues.fee);
    setBaseValue(cleanValues.baseValue);
    setFinalValue(cleanValues.finalValue);
    setCurrency(cleanValues.currency);
    setExchangeRate(cleanValues.exchangeRate);
    setTimestamp(cleanValues.timestamp);
    setClaimedByUser(cleanValues.claimedByUser);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          walletStakeAddress: walletStakeAddress ?? null,
          ...
          claimedByUser: claimedByUser ?? null,
        };
