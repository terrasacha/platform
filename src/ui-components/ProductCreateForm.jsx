...
export default function ProductCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setIsActiveOnPlatform(initialValues.isActiveOnPlatform);
    setShowOn(initialValues.showOn);
    setOrder(initialValues.order);
    setStatus(initialValues.status);
    setTimeOnVerification(initialValues.timeOnVerification);
    setProjectReadiness(initialValues.projectReadiness);
    setTokenClaimedByOwner(initialValues.tokenClaimedByOwner);
    setTokenGenesis(initialValues.tokenGenesis);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
