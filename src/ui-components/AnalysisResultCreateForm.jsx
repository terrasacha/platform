...
export default function AnalysisResultCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setFuente(initialValues.fuente);
    setModelo(initialValues.modelo);
    setCobertura(initialValues.cobertura);
    setValor(initialValues.valor);
    setUnidad(initialValues.unidad);
    setProyecto(initialValues.proyecto);
    setNombreImagen(initialValues.nombreImagen);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createAnalysisResult.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AnalysisResultCreateForm")}
      {...rest}
    >
      <TextField
        label="Fuente"
