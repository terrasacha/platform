...
import { createAnalysis } from "../graphql/mutations";
export default function AnalysisCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setImgAnteriorNombreImg(initialValues.imgAnteriorNombreImg);
    ...
    setImgAnteriorBandas(initialValues.imgAnteriorBandas);
    setImgPosteriorNombreImg(initialValues.imgPosteriorNombreImg);
    ...
    setImgPosteriorBandas(initialValues.imgPosteriorBandas);
    setResultados(initialValues.resultados);
    setAjustado(initialValues.ajustado);
    setErrors({});
  };
  const validations = {
    imgAnteriorNombreImg: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createAnalysis.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AnalysisCreateForm")}
      {...rest}
    >
      <TextField
